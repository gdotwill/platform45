...
var arrowMobile = document.querySelector('.arrow-mobile'); // Mobile arrow slide

arrowMobile.addEventListener('click', function () {
  var arrowUp = 'http://dev.hoppa.com/images/45/arrow-up@2x.png';
  var arrowDown = 'http://dev.hoppa.com/images/45/arrow-down@2x.png';
  var imgPropMobile = document.querySelector('.arrow-mobile');
...
arrow.addEventListener('click', function () {
  var arrowLeft = 'http://dev.hoppa.com/images/45/arrow-left@2x.png';
  var arrowRight = 'http://dev.hoppa.com/images/45/arrow-right@2x.png';
  var imgProp = document.querySelector('.arrow');
...
var tier = document.querySelector('.tier1');
...
//# sourceMappingURL=/script.989ed60e.js.map